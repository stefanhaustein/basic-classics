...
1660 IF H$="a flush in" THEN 1700
...
1865 PRINT Z; ": ";
1870 K=INT(A(Z)/100)
1875 IF K = 0 THEN PRINT "♣️";
1880 IF K = 1 THEN PRINT "♦️";
1885 IF K = 2 THEN PRINT "♥️";
1890 IF K = 3 THEN PRINT "♠️";
1895 K=FNB(A(Z))
1900 IF K >= 9 THEN PRINT " "; MID$("JQKA", K-8, 1)
1905 IF K < 9 THEN PRINT K+2   
1910 NEXT Z
1920 PRINT
1940 RETURN
1960 IF K = 9 THEN PRINT "Jack";
1970 IF K = 10 THEN PRINT "Queen";
1980 IF K = 11 THEN PRINT "King";
1990 IF K = 12 THEN PRINT "ACE";
2000 IF K < 9 THEN PRINT K+2;
2010 RETURN
2080 IF K = 0 THEN PRINT " Clubs";
2090 IF K = 1 THEN PRINT " Diamonds";
2100 IF K = 2 THEN PRINT " Hearts";
2110 IF K = 3 THEN PRINT " Spades";
2120 RETURN
2170 U=0
2180 FOR Z=N TO N+4
2190 B(Z)=FNB(A(Z))
...
3680 STOP
3690 PRINT H$;
3700 IF H$<>"a Flush in" THEN 3750
3710 K=INT(K/100)
3720 GOSUB 2080
3730 PRINT
3740 RETURN
3750 K=FNB(K)
3760 GOSUB 1960
3770 IF H$="Schmaltz, " THEN 3790
3780 IF H$<>"Straight" THEN 3810
3790 PRINT " high"
3800 RETURN
3810 PRINT "'s"
3820 RETURN
3830 PRINT
3840 PRINT "You can't bet with what you have't got."
